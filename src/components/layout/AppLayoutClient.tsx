...
import { LayoutDashboard, Video, FileText, MessageSquare, Activity, LogOut, UserCircle, ShieldCheck, Loader2, Settings, Sun, Moon, Users, VideoIcon, UploadCloud, Smartphone, FileUp } from 'lucide-react';
...
const MainSidebarContent = () => {
  ...
  const adminLinks = [
    { href: "/admin/recorder", label: "Record Video (Web)", icon: UploadCloud },
    { href: "/admin/video-recorder-ios", label: "Record Video (iOS)", icon: Smartphone },
    { href: "/admin/upload-video", label: "Upload Local Video", icon: FileUp },
    { href: "/admin/manage-content", label: "Manage Content", icon: Settings },
  ];
  
  let links = isAdmin ? [...commonLinks, ...adminLinks] : [...commonLinks];
